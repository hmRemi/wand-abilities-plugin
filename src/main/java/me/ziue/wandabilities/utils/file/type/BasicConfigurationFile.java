package me.ziue.wandabilities.utils.file.type;

import com.google.common.io.Files;
import me.ziue.wandabilities.WandAbilities;
import me.ziue.wandabilities.utils.file.AbstractConfigurationFile;
...
public class BasicConfigurationFile extends AbstractConfigurationFile {
    ...
    public void reload() {
        File file = new File(WandAbilities.getWandAbilities().getDataFolder(), getName() + ".yml");
        try {
    ...
    public void save() {
        File folder = WandAbilities.getWandAbilities().getDataFolder();
        try {
