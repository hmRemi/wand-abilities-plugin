package me.ziue.wandabilities.utils.chat;
...
public class CC {
    ...
    public static void loadPlugin() {
        ...
        Bukkit.getConsoleSender().sendMessage(translate("     &4\u2764 &9&l" + WandAbilities.getWandAbilities().getName() + " &4\u2764"));
        Bukkit.getConsoleSender().sendMessage(translate(""));
        Bukkit.getConsoleSender().sendMessage(translate(" &7\u27A5 &9Author&7: &f" + WandAbilities.getWandAbilities().getDescription().getAuthors().toString().replace("[", "").replace("]", "")));
        Bukkit.getConsoleSender().sendMessage(translate(" &7\u27A5 &9Version&7: &f" + WandAbilities.getWandAbilities().getDescription().getVersion()));
        Bukkit.getConsoleSender().sendMessage(translate(" "));
        Bukkit.getConsoleSender().sendMessage(translate(" &7\u27A5 &9Spigot&7: &f" + WandAbilities.getWandAbilities().getServer().getName()));
        Bukkit.getConsoleSender().sendMessage(translate(" "));
        Bukkit.getConsoleSender().sendMessage(translate(" &9Loaded info"));
        Bukkit.getConsoleSender().sendMessage(translate(" &7\u27A5 &9Abilities&7: &f" + Ability.getAbilities().size()));
        Bukkit.getConsoleSender().sendMessage(translate(" "));
